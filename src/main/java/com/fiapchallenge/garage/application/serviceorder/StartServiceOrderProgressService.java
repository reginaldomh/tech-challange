...
@Service
public class StartServiceOrderProgressService implements StartServiceOrderProgressUseCase {

    private final ServiceOrderRepository serviceOrderRepository;

    public StartServiceOrderProgressService(ServiceOrderRepository serviceOrderRepository) {
        this.serviceOrderRepository = serviceOrderRepository;
    }

    @Override
    @Transactional
    public ServiceOrder handle(StartServiceOrderProgressCommand command) {
